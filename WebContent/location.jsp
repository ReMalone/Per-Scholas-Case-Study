...
<body onload="noBack();" onunload="">
	...
	<table>
		...
		<tr>
			...
			<td><input name="addressLine1" type="text" pattern="[A-Za-z0-9,-/.\s]{1,50}" title="Alphanumeric and be less than 50 characters"/>
			</td>
		</tr>
		<tr>
			<td>Address Line 2</td>
			<td><input name="addressLine2" type="text" pattern="[A-Za-z0-9,-/.\s]{1,50}" title="Alphanumeric and be less than 100 characters"/>
			</td>
		</tr>
		<tr>
			<td>City</td>
			<td><input name="city" type="text" pattern="[A-Za-z0-9\s]{1,15}" title="Alphanumeric and be less than 15 characters"/>
			</td>
		</tr>
		<tr>
			<td>State</td>
			<td><input name="state" type="text" pattern="[A-Za-z0-9\s]{1,15}" title="Alphanumeric and be less than 15 characters"/>
			</td>
		</tr>
		<tr>
			<td>Zip</td>
			<td><input name="zip" type="text" pattern="[0-9]{1,10}" title="Numeric and be less than 10 characters"/>
			</td>
		</tr>
		<tr>
			<td>Residence Use</td>
