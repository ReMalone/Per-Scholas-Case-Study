...
<body><!--  onload="noBack();" onunload=""> -->
	...
	<table>
		<tr>
			...
			pattern="[0-9]{4,10}" title="Numberic charaters only and minimum of 10000"/>
			</td>
		</tr>
		<tr>
			<td>What year was your home originally built?</td>
			<td><input name="yearBuilt" type="text" 
			pattern="(19[2-8][0-9]|199[0-9]|200[0-9]|201[0-8])" title="Between 1920 and current year"/>
			</td>
		</tr>
		<tr>
			<td>Square footage</td>
			<td><input name="squareFootage" type="text" 
			pattern="[0-9]{3,10}" title="Numberic charaters only and minimum of 100"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="numFullBaths" type="text" pattern="[1-9]{1,2}" title="Numberic characters only"/>
			</td>
		</tr>
		<tr>
			<td>Number half baths</td>
			<td><input name="numHalfBaths" type="text" pattern="[0-9]{1,2}" title="Numberic characters only"/>
			</td>
		</tr>
		<tr>
			<td>Does your home have a swimming pool?</td>
			<td>
			<input type="radio" name="hasSwimmingPool" value="true" required />Yes<BR>
