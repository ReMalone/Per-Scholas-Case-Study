...
public class LocationDAO {
	...
	public int saveLocation(final Location location) throws HomequoteSystemException
	{
		...
		System.out.println("System got to LocationDAO on line 32");//Is the runtime getting to this servlet?
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet resultSet = null;
		int quoteId = 0;
		System.out.println("The object of location type of username is: "+location.getUserName());//verify username is going into the try catch
		try
		{
			...
			System.out.println(SqlQueries.SAVE_LOCATION); //print this out to make sure it works.
			stmt.setString(1, location.getResidenceType());
			System.out.println(location.getResidenceType());
			...
			stmt.executeUpdate();
			System.out.println("The system got to LocationDAO line 56 and committed info to DB.");
			...
			System.out.println(SqlQueries.GET_QUOTE_ID);//Verify statement
			stmt.setString(1, location.getResidenceType());
			stmt.setString(2, location.getAddressLine1());
			stmt.setString(3, location.getAddressLine2());
			stmt.setString(4, location.getCity());
			...
			System.out.println("The quoteId is: "+quoteId); //I want to see the number sent.
		}
